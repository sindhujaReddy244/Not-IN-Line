...
import nabl from "../images/Rectangle 80.png";
import free from "../images/Rectangle 81.png";
  ...
  return (
    <>
      ...
      <div className="expanding">
        <strong className='wekeep'>We keep </strong><span className='expand'>expanding!</span>
      </div>
        <svg className='svg1' xmlns="http://www.w3.org/2000/svg" width="265" height="21" viewBox="0 0 265 21" fill="none">
